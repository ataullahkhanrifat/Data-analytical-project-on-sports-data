...
def change_pw():
    while True:
        ...
        if new_password != input('Confirm password: \n'):
            ...
            continue
        pickle.dump(new_password, open(r'C:\Users\OneDrive - Technische Universität Dortmund\Desktop\Final Assignment\pw_file.p', 'wb'))
...
while True:
    try:
        password = pickle.load(open(r'C:\Users\OneDrive - Technische Universität Dortmund\Desktop\Final Assignment\pw_file.p', 'rb') )
    except:
        password = change_pw()
    ...
    if enter_password == password:
        while True:
            ...
            if option == "P": 
                secret_file = open(r'C:\Users\OneDrive - Technische Universität Dortmund\Desktop\Final Assignment\password-20221001\secret_file.txt', 'r', encoding='utf8')
